          ...
          <div style={{ minHeight: '100vh', backgroundColor: IV, fontFamily: 'Inter, sans-serif' }}>
            {/* Header */}
                <div style={{ backgroundColor: G, padding: '28px 24px 20px' }}>
                        <div style={{ maxWidth: 1300, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                  <div>
                                              <div style={{ fontSize: 11, letterSpacing: 4, color: AU, textTransform: 'uppercase', marginBottom: 6 }}>Valör Admin</div>div>
                                              <h1 style={{ fontSize: 26, fontFamily: 'Georgia, serif', color: WH, fontWeight: 400, margin: 0 }}>Kontrollpanel</h1>h1>
                                  </div>div>
                                  <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                                              <a href="/" style={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, textDecoration: 'none' }}>← Tillbaka till siten</a>a>
                                              <button
            ...
            { label: 'Intäkter', value: `${stats.revenue} kr`, icon: '💰' },
                                    ...
                                    <div key={i} style={{ flex: 1, textAlign: 'center', padding: '16px 0', borderRight: i < 4 ? `1px solid ${LG}` : 'none' }}>
                                                  <div style={{ fontSize: 24 }}>{s.icon}</div>div>
                                                  <div style={{ fontSize: 22, fontWeight: 700, color: G, marginTop: 4 }}>{s.value}</div>div>
                                                  <div style={{ fontSize: 12, color: GR, marginTop: 2 }}>{s.label}</div>div>
                                    </div>div>
                                  ))}
                        </div>div>
                </div>div>
            ...
            {/* Tabs */}
                ...
                <div style={{ maxWidth: 1300, margin: '0 auto', padding: '32px 24px' }}>
                  ...
                  {activeTab === 'orders' && (
                      <div style={{ backgroundColor: WH, borderRadius: 12, border: `1px solid ${LG}`, overflow: 'hidden' }}>
                                  <div style={{ padding: '20px 24px', borderBottom: `1px solid ${LG}` }}>
                                                <h2 style={{ fontSize: 18, color: G, fontFamily: 'Georgia, serif', fontWeight: 400, margin: 0 }}>Beställningar</h2>h2>
                                  </div>div>
                                  <div style={{ overflowX: 'auto' }}>
                                              ...
                                              <th key={h} style={{ padding: '12px 16px', textAlign: 'left', fontSize: 12, color: GR, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1 }}>{h}</th>th>
                                            ))}
                                                                                    </tr>tr>
                                                                </thead>thead>
                                                                <tbody>
                                            ...
                                            <tr key={o.id} style={{ borderTop: `1px solid ${LG}`, backgroundColor: '#fff' }}>
                                                                  <td style={{ padding: '12px 16px', fontSize: 14, color: G }}>{o.profiles?.email}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{o.deals?.title}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 14, color: G, fontWeight: 600 }}>{o.total_price} kr</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: AU }}>{o.status}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{new Date(o.created_at).toLocaleDateString('sv-SE')}</td>td>
                                            </tr>tr>
                                          ))}
                                                                </tbody>tbody>
                                                </table>table>
                  ...
                  {activeTab === 'vouchers' && (
                      <div style={{ backgroundColor: WH, borderRadius: 12, border: `1px solid ${LG}`, overflow: 'hidden' }}>
                                  <div style={{ padding: '20px 24px', borderBottom: `1px solid ${LG}` }}>
                                                <h2 style={{ fontSize: 18, color: G, fontFamily: 'Georgia, serif', fontWeight: 400, margin: 0 }}>Vouchers</h2>h2>
                                  </div>div>
                                  <div style={{ overflowX: 'auto' }}>
                                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                                                <thead>
                                            ...
                                            <tr key={v.id} style={{ borderTop: `1px solid ${LG}`, backgroundColor: '#fff' }}>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: G, fontWeight: 600 }}>{v.code}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{v.profiles?.email}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: G }}>{v.deals?.title}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{v.deals?.merchants?.name}</td>td>
                  ...
                  {activeTab === 'merchants' && (
                      <div style={{ backgroundColor: WH, borderRadius: 12, border: `1px solid ${LG}`, overflow: 'hidden' }}>
                                  <div style={{ padding: '20px 24px', borderBottom: `1px solid ${LG}` }}>
                                                <h2 style={{ fontSize: 18, color: G, fontFamily: 'Georgia, serif', fontWeight: 400, margin: 0 }}>Handlare</h2>h2>
                                  </div>div>
                                  <div style={{ overflowX: 'auto' }}>
                                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                                                <thead>
                                            ...
                                            <tr key={m.id} style={{ borderTop: `1px solid ${LG}`, backgroundColor: '#fff' }}>
                                                                  <td style={{ padding: '12px 16px', fontSize: 14, color: G, fontWeight: 500 }}>{m.name}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{m.email}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: G }}>{m.city}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: AU }}>{m.status || 'active'}</td>td>
                                            </tr>tr>
                                          ))}
                                                                </tbody>tbody>
                                                </table>table>
                  ...
                  {activeTab === 'deals' && (
                      <div style={{ backgroundColor: WH, borderRadius: 12, border: `1px solid ${LG}`, overflow: 'hidden' }}>
                                  <div style={{ padding: '20px 24px', borderBottom: `1px solid ${LG}` }}>
                                                <h2 style={{ fontSize: 18, color: G, fontFamily: 'Georgia, serif', fontWeight: 400, margin: 0 }}>Deals</h2>h2>
                                  </div>div>
                                  <div style={{ overflowX: 'auto' }}>
                                                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                                                <thead>
                                            ...
                                            <tr key={d.id} style={{ borderTop: `1px solid ${LG}`, backgroundColor: '#fff' }}>
                                                                  <td style={{ padding: '12px 16px', fontSize: 14, color: G, fontWeight: 500 }}>{d.title}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{d.merchants?.name}</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 14, color: G, fontWeight: 600 }}>{d.deal_price} kr</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: AU }}>{d.discount_pct}%</td>td>
                                                                  <td style={{ padding: '12px 16px', fontSize: 13, color: GR }}>{d.sold_count || 0}</td>td>
                                                                  <td style={{ padding: '12px 16px' }}>
                  ...
                  {activeTab === 'overview' && (
                      <div>
                                  <h2 style={{ fontSize: 18, color: G, fontFamily: 'Georgia, serif', fontWeight: 400, margin: '0 0 20px' }}>Senaste aktivitet</h2>h2>
                                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                                                <div style={{ backgroundColor: WH, borderRadius: 12, padding: 24, border: `1px solid ${LG}` }}>
                                                                <h3 style={{ fontSize: 14, color: G, fontWeight: 600, margin: '0 0 16px' }}>Senaste beställningar</h3>h3>
                                                  {orders.slice(0, 5).map(o => (
                                          <div key={o.id} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: `1px solid ${LG}` }}>
                                                              <span style={{ fontSize: 13, color: G }}>{o.deals?.title?.substring(0, 30)}...</span>span>
                                                              <span style={{ fontSize: 13, color: AU, fontWeight: 600 }}>{o.total_price} kr</span>span>
                                          </div>div>
                                        ))}
                                                </div>div>
                                                <div style={{ backgroundColor: WH, borderRadius: 12, padding: 24, border: `1px solid ${LG}` }}>
                                                                <h3 style={{ fontSize: 14, color: G, fontWeight: 600, margin: '0 0 16px' }}>Senaste vouchers</h3>h3>
                                                  {vouchers.slice(0, 5).map(v => (
                                          <div key={v.id} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: `1px solid ${LG}` }}>
                                                              <span style={{ fontSize: 13, color: G }}>{v.code}</span>span>
                                                              <span style={{ fontSize: 11, color: v.status === 'active' ? '#059669' : GR, fontWeight: 600 }}>{v.status}</span>span>
                                          </div>div>
                                        ))}
                                                </div>div>
                                  </div>div>
