  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-gray-900 rounded-3xl p-8 text-center shadow-2xl border border-gray-800">
        <p className="text-gray-400 text-xs font-semibold tracking-widest uppercase mb-6">valor.se</p>
        ...
        {/* QR-kod renderas client-side */}
        <VoucherQR voucherUrl={voucherUrl} isUsed={isUsed} />
        ...
        <p className="text-gray-700 text-xs mt-6">Visa denna sida for handlaren vid inlosen</p>
      </div>
    </div>
  )
}
