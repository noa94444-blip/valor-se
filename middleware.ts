Ö–import { createServerClient } from '@supabase/ssr'
...
const BAD_BOTS = ['sqlmap', 'nikto', 'masscan', 'nmap', 'zgrab', 'dirbuster', 'hydra', 'burpsuite', 'acunetix', 'nessus', 'openvas', 'w3af', 'havij']
...
export async function middleware(request: NextRequest) {
  ...
  // Banned users get redirected out
